...
class RoleMiddlewareTest extends TestCase
{
    ...
    public function testAssignRole()
    {
        ...
        $this->actingAs(Auth::user())->get(sprintf('api/%s/%s/%s', 'users', $this->testUserId, 'roles'));
    ...
    public function testRevokeRole()
    {
        ...
        $this->actingAs($testUser)
               ->get(sprintf('api/%s/%s/%s', 'users', $this->testUserId, 'roles'));
        ...
        $this->actingAs($testUser)->get(sprintf('api/%s/%s/%s', 'users', $this->testUserId, 'roles'));
    ...
    {
        $this->actingAs(Auth::user())->post('api/roles/intern');
        ...
        $this->actingAs(Auth::user())->post('api/roles/mm');
    ...
    public function testDeleteRole()
    {
        ...
        $this->actingAs(Auth::user())->delete(sprintf('api/%s/%s', 'roles', $internId));
    ...
    public function testInactiveRole()
    {
        ...
        $this->actingAs(Auth::user())->get('api/users/5FFA95F4-5EB4-46FB-94F1-F2B27254725B/roles');
        $this->assertResponseStatus(200);

        $this->actingAs(Auth::user())->post(sprintf('api/%s/%s/%s', 'roles', $this->adminUserId, 'deactivate'));
    ...
    public function testActivateRole()
    {
        ...
        $this->actingAs(Auth::user())->post(sprintf('api/%s/%s/%s', 'roles', $internId, 'deactivate'));
        ...
        $this->actingAs(Auth::user())->post(sprintf('api/%s/%s/%s', 'roles', $internId, 'activate'));
    ...
    public function testGetInvalidRole()
    {
        ...
        $this->actingAs(Auth::user())->get(sprintf('api/%s/%s', 'roles', Uuid::generate(4)->string));
        $this->assertEquals('{"error":"Invalid Role ID"}', $this->response->getContent());
    }
    ...
    {
        $this->actingAs(Auth::user())->get(sprintf('api/%s/%s/%s', 'roles', $this->adminUserId, 'users'));
